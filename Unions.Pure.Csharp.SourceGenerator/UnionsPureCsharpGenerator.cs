...
";
        ...
        public void Initialize(IncrementalGeneratorInitializationContext initContext)
        {
            ...
            // Emit Swagger/OpenAPI schema mappings when the project references Swashbuckle (e.g. AOT apps).
            initContext.RegisterSourceOutput(compilationAndTargets, static (spc, pair) =>
            {
                var (compilation, candidates) = pair;
                ...
                var source = GenerateSwaggerGenSource(unionTypes);
            ...
            List<(INamedTypeSymbol TypeSymbol, ITypeSymbol[] Members, string[] TagIds)> unionTypes)
        {
            ...
            sb.AppendLine("    /// Swagger/OpenAPI schema mappings for union types (e.g. for AOT apps where reflection-based schema gen fails).");
            sb.AppendLine("    /// Call from AddSwaggerGen: configure.AddPureUnionsSwaggerGen();");
            sb.AppendLine("    /// </summary>");
            sb.AppendLine("    public static partial class PureUnionsSwaggerGen");
            sb.AppendLine("    {");
