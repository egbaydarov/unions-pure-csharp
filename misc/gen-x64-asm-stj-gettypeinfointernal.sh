...
out_file="$out_dir/unions-pure-csharp-demo-x64-asm-stj-gettypeinfointernal-$ts.txt"
...
echo "Running demo with System.Text.Json JsonSerializerOptions:GetTypeInfoInternal* disasm…" >&2
...
(
  ...
  export COMPlus_JitDisasm="System.Text.Json.JsonSerializerOptions:GetTypeInfoInternal*"
